...
export default function Curriculum02() {
  const list = [
    {
      title: '원화의 드로잉 방법',
      img: 'https://highclass-image.s3.amazonaws.com/academy/hc_design/eximg/curri02.webp',
      content: [
        {
    ...
    {
      title: '원화의 드로잉 방법',
      img: 'https://highclass-image.s3.amazonaws.com/academy/hc_design/eximg/curri01.webp',
      content: [
        {
          tit: '학습상담',
