...
export default function RankingCard() {
  const list = [
    ...
    },
    {
      ...
      img: 'https://highclass-image.s3.amazonaws.com/academy/hc_design/eximg/new05.webp',
      subs: '개념도 익히고 실습도 하며 리액트를 배우는 프론트엔드 초급자를 위한 강의',
      link: '/detail/1',
    },
    {
      title: '프로가 알려주는 생생한 노하우 프로그램의 시작',
      img: 'https://highclass-image.s3.amazonaws.com/academy/hc_design/eximg/new06.webp',
    ...
    },
    {
      ...
      img: 'https://highclass-image.s3.amazonaws.com/academy/hc_design/eximg/new08.webp',
      subs: 'Micro Frontend부터 모노레포까지 대규모 서비스를 위한 프론트엔드 아키텍처',
      link: '/detail/1',
    },
    {
      title: '만들면서 익히는 React의 모든 것 With. 25개 스택',
      img: 'https://highclass-image.s3.amazonaws.com/academy/hc_design/eximg/new09.webp',
    ...
    },
    {
      ...
      img: 'https://highclass-image.s3.amazonaws.com/academy/hc_design/eximg/new10.webp',
