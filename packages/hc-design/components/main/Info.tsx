            ...
            <li className="border-b border-zinc-200">
              ...
              >
                <p className="relative pl-5 text-base after:w-0.5 after:h-0.5 after:absolute after:left-2 after:top-[50%] after:-mt-0.25 after:bg-zinc-800 after:rounded-full">
                  영상 속 다양한 움직임과 효과를 주는 모션그래픽!
                </p>
                <p className="text-sm text-zinc-500">2024.01.09</p>
              </Link>
            </li>
            <li className="border-b border-zinc-200">
              <Link
            ...
            <SwiperSlide>
              <div className="px-2">
                ...
                >
                  <img
                    alt="instagram 이벤트"
                    src="https://highclass-image.s3.amazonaws.com/academy/hc_design/eximg/b01.webp"
                    width="100%"
                  />
                </Link>
              </div>
            ...
            <SwiperSlide>
              <div className="px-2">
                ...
                >
                  <img
                    alt="instagram 이벤트"
                    src="https://highclass-image.s3.amazonaws.com/academy/hc_design/eximg/b02.webp"
                    width="100%"
                  />
                </Link>
              </div>
            ...
            <SwiperSlide>
              <div className="px-2">
                ...
                >
                  <img
                    alt="instagram 이벤트"
                    src="https://highclass-image.s3.amazonaws.com/academy/hc_design/eximg/b03.webp"
                    width="100%"
                  />
                </Link>
              </div>
            ...
            <SwiperSlide>
              <div className="px-2">
                ...
                >
                  <img
                    alt="instagram 이벤트"
                    src="https://highclass-image.s3.amazonaws.com/academy/hc_design/eximg/b04.webp"
                    width="100%"
                  />
                </Link>
              </div>
            ...
            <SwiperSlide>
              <div className="px-2">
                ...
                >
                  <img
                    alt="instagram 이벤트"
                    src="https://highclass-image.s3.amazonaws.com/academy/hc_design/eximg/b05.webp"
                    width="100%"
                  />
                </Link>
              </div>
            ...
            <SwiperSlide>
              <div className="px-2">
                ...
                >
                  <img
                    alt="instagram 이벤트"
                    src="https://highclass-image.s3.amazonaws.com/academy/hc_design/eximg/b06.webp"
                    width="100%"
                  />
                </Link>
              </div>
