    ...
    <>
      <div className="flex flex-wrap items-center justify-between py-5 wrap">
        <div className="relative w-4/6 xl:w-3/6">
          <ul className="flex justify-between">
            <li>
              <Link
                href="/consult"
                className="flex flex-col items-center p-3 text-white border-2 rounded-lg bg-primary border-primary"
              >
            ...
            <li>
              <Link
                href="/consult"
                className="flex flex-col items-center p-3 border-2 rounded-lg border-primary text-primary"
              >
                <span className="text-3xl/none">
                  <i className="xi-emoticon-smiley-o" />
                </span>
        ...
        <div className="flex w-2/6 px-5 lg:flex-col xl:flex-row">
          <h4 className="w-1/5 pr-3 text-xl font-bold text-primary">NOTICE</h4>
          <Swiper
            direction={'vertical'}
            autoplay={{
              delay: 1000,
