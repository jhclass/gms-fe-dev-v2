...
export default function Portfolio() {
  const list = [
    {
      name: '김○○',
      img: 'https://highclass-image.s3.amazonaws.com/academy/hc_design/eximg/user01.webp',
      content:
        '비전공자라서 개념 학습 및 정리만 해도 많은 시간이 소요되는 분 평생 소장 가능한 도식화된 강사님의 특별 강의 자료로 개념 정리 및 복습이 용이합니다.',
      class: '프론트엔드',
      rating: 3.7,
    },
    {
    ...
    <>
      ...
      <div className={`relative mt-5 max-w-[1440px] mx-auto main-review`}>
          ...
          {list.map((item, index) => (
            <SwiperSlide key={index}>
              <div className="flex flex-row items-center px-4 py-5 overflow-hidden rounded-t-lg rounded-br-lg bg-zinc-600 rounded-e-lg">
                <div className="w-2/7 min-w-[6rem] mr-7">
        ...
        <div className="hidden absolute top-[-3rem] right-0 lg:flex">
          <button className="p-1 text-2xl text-white slide_prev">
            <i className="xi-angle-left-min" />
          </button>
          <button className="p-1 text-2xl text-white slide_next">
