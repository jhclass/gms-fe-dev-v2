...
const list = [
  {
    name: '김○○',
    img: 'https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/common/user_m.webp',
    content:
  ...
  {
    name: '최○○',
    img: 'https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/common/user_w.webp',
    content:
      ...
      <section className="bg-white">
        <div className="text-center wrap">
          ...
          <figure className="w-full mx-auto mt-10">
            <img src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_main_section.webp" />
          </figure>
        </div>
      </section>
          ...
          <div className="flex flex-wrap justify-between py-10 border-b-1">
            ...
            <div className="w-full text-base lg:w-1/2">
              <figure className="w-[70%] mb-10 ">
                <img
                  src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_img_info.webp"
                  width="100%"
                />
              </figure>
      ...
      <section className="pb-16 bg-white">
        <div className="wrap">
          ...
          <div className="grid w-full grid-cols-4 gap-5 mt-10 lg:grid-cols-7">
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con01.webp"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con02.webp"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con03.webp"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con04.webp"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con05.webp"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con06.webp"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con07.gif"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con08.gif"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con09.gif"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con10.gif"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con11.gif"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con12.gif"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con13.gif"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con14.gif"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con15.webp"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con16.gif"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con17.gif"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con18.gif"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con19.gif"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con20.gif"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con21.gif"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con22.gif"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con23.gif"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con24.gif"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con25.gif"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con26.gif"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con27.gif"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con28.gif"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con29.gif"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con30.gif"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con31.gif"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con32.gif"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con33.webp"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con34.webp"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con35.webp"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con36.gif"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con37.gif"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con38.gif"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con39.gif"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con40.gif"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con41.gif"
              alt=""
              width="100%"
            />
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/03/d3_con42.gif"
              alt=""
              width="100%"
            />
          </div>
      ...
      <section className="pb-16 bg-white">
        <div className="wrap">
          <div className="text-center">
            ...
            <ul className="grid w-full grid-cols-2 gap-10 mt-10">
              <li className="relative p-6 text-left text-[#021226] border-2 border-[#71717a] rounded-lg">
                <h5 className="relative text-xl font-semibold pl-4 after:content-['|'] after:text-[#F26E22] after:absolute after:left-[0.2rem] after:top-[-0.05rem]">
                  <span className="text-[#F26E22] font-bold pr-2">
                    Step 01.
                  </span>
                  이모티콘 제작의 이해
                </h5>
              ...
              <li className="relative p-6 text-left text-[#021226] border-2 border-[#71717a] rounded-lg">
                <h5 className="relative text-xl font-semibold pl-4 after:content-['|'] after:text-[#F26E22] after:absolute after:left-[0.2rem] after:top-[-0.05rem]">
                  <span className="text-[#F26E22] font-bold pr-2">Step 10</span>
                  GifCam을 활용한 애니메이션
                </h5>
                <ul className="mt-3 text-base">
                  <li className="relative mt-1 pl-4 after:content-['∙'] after:absolute after:left-0 after:top-[-0.05rem]">
              ...
              <li className="relative p-6 text-left text-[#021226] border-2 border-[#71717a] rounded-lg">
                <h5 className="relative text-xl font-semibold pl-4 after:content-['|'] after:text-[#F26E22] after:absolute after:left-[0.2rem] after:top-[-0.05rem]">
                  <span className="text-[#F26E22] font-bold pr-2">Step 11</span>
                  움직이는 이모티콘 완성
                </h5>
                <ul className="mt-3 text-base">
                  <li className="relative mt-1 pl-4 after:content-['∙'] after:absolute after:left-0 after:top-[-0.05rem]">
              ...
              <li className="p-6 text-left text-[#021226] border-2 border-[#F26E22] rounded-lg bg-[#F26E22]">
                ...
                <h5 className="relative text-xl font-semibold pl-4 after:content-['|'] after:absolute after:left-[0.2rem] after:top-[-0.05rem]">
                  <span className="pr-2 font-bold">Step 12</span>. 이모티콘
                  크리에이터가 되기 위한 노하우
                </h5>
                <ul className="mt-3 text-base">
                  <li className="relative mt-1 pl-4 after:content-['∙'] after:absolute after:left-0 after:top-[-0.05rem]">
            ...
            <div className="flex flex-col py-6 lg:flex-row even:lg:flex-row-reverse">
              <div className="flex mx-auto mb-5 w-[15rem] h-[15rem] lg:mx-8 lg:w-[21rem] lg:h-[21rem]">
                <figure className="w-full h-full p-3 overflow-hidden bg-teal-500 rounded-full">
                  <img
                    src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/common/user_w.webp"
                    alt="김○○의 포트폴리오"
                    loading="lazy"
                    width="100%"
                  />
            ...
            <div className="flex flex-col py-6 lg:flex-row even:lg:flex-row-reverse">
              <div className="flex mx-auto mb-5 w-[15rem] h-[15rem] lg:mx-8 lg:w-[21rem] lg:h-[21rem]">
                <figure className="w-full h-full p-3 overflow-hidden rounded-full bg-sky-700">
                  <img
                    src="https://highclass-image.s3.amazonaws.com/academy/hc_design/detail/common//user_m.webp"
                    alt="이○○의 포트폴리오"
                    loading="lazy"
                    width="100%"
                  />
