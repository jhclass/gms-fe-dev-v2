      ...
      <section>
        ...
        <div className="max-w-[1440px] mx-auto my-0">
          ...
          <BtnSection>
            <Link href={'#'}>
              <img
                src="https://highclass-image.s3.amazonaws.com/academy/hc_design/2024/page/motion_premiere_btn.webp"
                alt="수강료 조회"
                className="hidden w-full wmd:block"
              ></img>
              <img
                src="https://highclass-image.s3.amazonaws.com/academy/hc_design/2024/page/mo/motion_premiere_btn.webp"
                alt="수강료 조회"
                className="block w-full wmd:hidden"
              ></img>
            </Link>
