      ...
      <section>
        <div>
          <div className="max-w-[2000px] mx-auto my-0">
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/2024/page/motion_premiere_01.png"
        ...
        <div className="max-w-[1440px] mx-auto my-0">
          <img
            src="https://highclass-image.s3.amazonaws.com/academy/hc_design/2024/page/motion_premiere_02.png"
          ...
          <BtnSection>
            <Link href={'#'}>
              <img
                src="https://highclass-image.s3.amazonaws.com/academy/hc_design/2024/page/motion_premiere_btn.png"
                alt="수강료 조회"
                className="hidden w-full wmd:block"
              ></img>
              <img
                src="https://highclass-image.s3.amazonaws.com/academy/hc_design/2024/page/mo/motion_premiere_btn.png"
                alt="수강료 조회"
                className="block w-full wmd:hidden"
              ></img>
            </Link>
            ...
            ></img>
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/2024/page/motion_premiere_03.png"
              alt="에이치아카데미 교육특성 @ 포트폴리오의 질이 다른 이유? 결과가 증명합니다.
              현업 디자이너 중심의 전문강사진 운영 | 기획이 반영된 포트폴리오 &개인별 맞춤 취업지원 | 디자이너 실무자를 초청한 트렌드 파악시간 제공 | 포트폴리오 제작을 위한 쾌적한 환경제공
              수강신청 절차 @ 컨설팅 전문가들의 개인면담을 통해, 개인의 실력에 맞춘 전문교육을 진행합니다.
              01 전화. 온라인 정보조회 | 홈페이지를 통해 정보확인 후, 전화, 온라인을 통한 간편조회. 과정별 담당자 매칭
