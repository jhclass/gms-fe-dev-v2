      ...
      <section>
        <div>
          <div className="max-w-[2000px] mx-auto my-0 relative">
            ...
            <TopText>
              <img
                src="https://highclass-image.s3.amazonaws.com/academy/hc_design/2024/page/artwork_game_01.png"
              ...
              ></img>
              <img
                src="https://highclass-image.s3.amazonaws.com/academy/hc_design/2024/page/mo/artwork_game_01.png"
                alt="게임원화 과정소개 @GAME DRAWING
                컨셉아트의 기본부터 작품완성까지, 내가 그리는 게임, 주목받는 테크닉 트레이닝!! 게임컨셉아트를 이해하고 그에 따른 세계관 구성과 장르별 특성을 파악. 게임에 어울리는 컨셉을 설정하여 독창성있고 주목성있는 컨셉아트 완성을 목표로 진행되는 강좌입니다."
        ...
        <div className="max-w-[1440px] mx-auto my-0">
          <div className="hidden w-full wmd:block">
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/2024/page/artwork_game_02.png"
            ...
            <BtnSection>
              <Link href={'#'}>
                <img
                  src="https://highclass-image.s3.amazonaws.com/academy/hc_design/2024/page/artwork_game_btn.png"
                  alt="수강료 조회"
                ></img>
              </Link>
              <img
                src="https://highclass-image.s3.amazonaws.com/academy/hc_design/2024/page/artwork_game_03.png"
          ...
          <MoCon>
            <MoDeco>
              <img
                src="https://highclass-image.s3.amazonaws.com/academy/hc_design/2024/page/mo/artwork_game_deco.png"
                alt=""
              />
            </MoDeco>
            <img
              src="https://highclass-image.s3.amazonaws.com/academy/hc_design/2024/page/mo/artwork_game_02.png"
              alt="Step .01 게임원화 이해 | 빛과 그림자 개념 이해 및 표현 입체표현 원리 이해 컨셉 조사 및 이미지 매칭 모작,
              Step .02 장르별 캐릭터 이해.01 | 소화 가능한 캐릭터 선택 및 파악 게임 장르별 캐릭터의 특성 이해 장르별 복식 이해 측면, 뒷면 묘사 모작,
              Step .03 장르별 캐릭터 이해.02 | 장르별 캐릭터 디테일 수정 및 표현기법 스킬업 학생 수준에 따른 배경추가 다각도에 따른 측면, 뒷면 세분화 묘사 모작,
              Step .04 레벨 디자인 | 레벨 디자인 이해 레벨 특성에 따른 캐릭터 의상 디테일 표현 의상 형태에 따른 레벨 특성 전달력 학습 창작,
            ...
            <BtnSection>
              <Link href={'#'}>
                <img
                  src="https://highclass-image.s3.amazonaws.com/academy/hc_design/2024/page/mo/artwork_game_btn.png"
                  alt="수강료 조회"
                ></img>
              </Link>

              <img
                src="https://highclass-image.s3.amazonaws.com/academy/hc_design/2024/page/mo/artwork_game_03.png"
                alt="에이치아카데미 교육특성 @ 포트폴리오의 질이 다른 이유? 결과가 증명합니다.
                현업 디자이너 중심의 전문강사진 운영, 기획이 반영된 포트폴리오 & 개인별 맞춤 취업지원, 디자이너 실무자를 초청한 트렌드 파악시간 제공, 포트폴리오 제작을 위한 쾌적한 환경제공
                "
              ></img>
