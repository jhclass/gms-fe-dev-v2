      ...
      <section className="bg-white">
        <div className="text-center wrap">
          <p className="pt-20 text-center text-black">
            <b className="inline-block text-4xl/[3rem]">
              웹툰작가에게 배우는
              <br />
              웹툰제작과정 Webtoon
            </b>
            ...
            <ul className="mx-auto mt-10 lg:w-full xl:w-4/5">
              <li className="relative p-6 mb-20 text-left text-white border-2 border-white rounded-lg">
                ...
                <ul className="mt-3 text-base">
                  ...
                  <li className="relative pt-5 pl-4 mt-5 border-white border-t-1">
              ...
              <li className="relative p-6 mb-20 text-left text-[#CDFBFF] border-2 border-[#CDFBFF] rounded-lg">
                <span className="absolute bottom-[-5rem] left-[50%] text-6xl ml-[-1.5rem]">
                  <i className="xi-angle-down" />
                </span>
                <h5 className="relative text-xl font-semibold pl-4 after:content-['|'] after:absolute after:left-[0.2rem] after:top-[-0.05rem]">
                ...
                <ul className="mt-3 text-base">
                  ...
                  <li className="relative pt-5 pl-4 mt-5 border-[#CDFBFF] border-t-1">
              ...
              <li className="relative p-6 mb-20 text-left text-[#6BEDF9] border-2 border-[#6BEDF9] rounded-lg">
                <span className="absolute bottom-[-5rem] left-[50%] text-6xl ml-[-1.5rem]">
                  <i className="xi-angle-down" />
                </span>
                <h5 className="relative text-xl font-semibold pl-4 after:content-['|'] after:absolute after:left-[0.2rem] after:top-[-0.05rem]">
                ...
                <ul className="mt-3 text-base">
                  ...
                  <li className="relative pt-5 pl-4 mt-5 border-[#6BEDF9] border-t-1">
              ...
              <li className="mt-10 p-6 text-left text-black border-2 border-[#42E0EF] rounded-lg bg-[#42E0EF]">
                <span className="text-[#42E0EF] border-2 border-black bg-black text-center text-xl py-1 px-4 inline-block mb-2">
                  Final Portfolio.
                </span>
                <h5 className="relative text-xl font-semibold pl-4 after:content-['|'] after:absolute after:left-[0.2rem] after:top-[-0.05rem]">
                  Step 13. 단편 웹툰 제작
