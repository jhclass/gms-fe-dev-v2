        ...
        <div className="wrap">
          <ul className="grid gap-8 sm:grid-cols-1 lg:grid-cols-2">
            <li className="flex flex-col items-center px-10 py-8 bg-white rounded-lg">
              <img
                src="https://highclass-image.s3.amazonaws.com/academy/hc_it/eximg/de_con01.webp"
                className="w-24"
              />
            ...
            <li className="flex flex-col items-center px-10 py-8 bg-white rounded-lg">
              <img
                src="https://highclass-image.s3.amazonaws.com/academy/hc_it/eximg/de_con02.webp"
                className="w-24"
              />
            ...
            <li className="flex flex-col items-center px-10 py-8 bg-white rounded-lg">
              <img
                src="https://highclass-image.s3.amazonaws.com/academy/hc_it/eximg/de_con03.webp"
                className="w-24"
              />
              <p className="mt-5 text-lg font-bold">
                SSR/SSG을 활용한 SEO 최적화
            ...
            <li className="flex flex-col items-center px-10 py-8 bg-white rounded-lg">
              <img
                src="https://highclass-image.s3.amazonaws.com/academy/hc_it/eximg/de_con04.webp"
                className="w-24"
              />
              <p className="mt-5 text-lg font-bold">
                SSR/SSG을 활용한 SEO 최적화
