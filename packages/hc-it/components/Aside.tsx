...
export default function Aside() {
  ...
  return (
    <>
      <aside id="aside" className={`${asideHidden ? 'opacity-0' : 'opacity-100'} ${moAsideOpen ? 'translate-x-0':'translate-x-[calc(100%+0.01rem)]'} bg-zinc-700/80 py-3 px-2 bottom-[5%] rounded-s-lg right-0 fixed z-40 lg:py-0 lg:px-0 lg:bg-transparent lg:right-16 xl:right-16 lg:bottom-28 transition-all`}>
