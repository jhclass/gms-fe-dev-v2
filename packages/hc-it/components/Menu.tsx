...
export default function Menu() {
  ...
  return (
    <>
      <div className={`${moMenuOpen ? 'translate-x-0' : 'translate-x-full'} transition-all duration-150 ease-in-out fixed flex justify-end top-0 right-0 w-full h-[100%] z-50`}>
        <div className="w-[90%] h-full bg-white">
          <div className="px-3 items-center justify-between flex h-[5rem] bg-white">
            <Link href="#" className="flex items-center">
              <span className="mr-1 text-5xl text-primary"><i className="xi-profile" /></span>
          ...
          <ul className="items-center text-center justify-between flex h-[4rem] border-b-1 border-t-1">
            <li className="w-1/2 h-full bg-white">
              <Link href="/consult" className="block w-full h-full text-lg/[4rem] font-bold text-primary">
                상담신청
              </Link>
            </li>
            <li className="w-1/2 h-full bg-primary">
              <Link href="#" onClick={handleTest} className="block w-full h-full text-lg/[4rem] font-bold text-white">
                고객센터
              </Link>
            </li>
          </ul>
