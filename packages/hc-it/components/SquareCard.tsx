  ...
  const list = [
    {
      ...
      img: 'https://highclass-image.s3.amazonaws.com/academy/hc_it/eximg/new03.webp',
    ...
    },
    {
      ...
      img: 'https://highclass-image.s3.amazonaws.com/academy/hc_it/eximg/new04.webp',
      subs: '[내일배움카드] 국비지원으로 배우는 1:8 웹 개발 왕초보 입문',
      link: '/detail/1',
    },
    {
      title: '하나 하나 따라하며 배우는 리액트 A-Z',
      img: 'https://highclass-image.s3.amazonaws.com/academy/hc_it/eximg/new05.webp',
      subs: '개념도 익히고 실습도 하며 리액트를 배우는 프론트엔드 초급자를 위한 강의',
      link: '/detail/1',
    },
    {
      title: '프로가 알려주는 생생한 노하우 프로그램의 시작',
      img: 'https://highclass-image.s3.amazonaws.com/academy/hc_it/eximg/new06.webp',
      subs: '프로그래밍, 크리에이티브, 커리어까지 사전 지식 없이 누구나 배울 수 있는 강의모음',
      link: '/detail/1',
    },
    {
      title: 'SIGNATURE 프론트엔드 웹 개발의 모든 것',
      img: 'https://highclass-image.s3.amazonaws.com/academy/hc_it/eximg/new07.webp',
      subs: '프론트엔드 웹 개발의 모든 것 사전 지식이 없어도 강의 하나로 입문부터 실전까지 ',
      link: '/detail/1',
    },
    {
      title: '마이크로 프론트엔드 대규모서비스를 위한 서비스 아키텍처',
      img: 'https://highclass-image.s3.amazonaws.com/academy/hc_it/eximg/new08.webp',
      subs: 'Micro Frontend부터 모노레포까지 대규모 서비스를 위한 프론트엔드 아키텍처',
      link: '/detail/1',
    },
    {
      title: '만들면서 익히는 React의 모든 것 With. 25개 스택',
      img: 'https://highclass-image.s3.amazonaws.com/academy/hc_it/eximg/new09.webp',
    ...
    },
    {
      ...
      img: 'https://highclass-image.s3.amazonaws.com/academy/hc_it/eximg/new10.webp',
