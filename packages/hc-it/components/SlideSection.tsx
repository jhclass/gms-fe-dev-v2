      ...
      <div className="overflow-hidden xl:overflow-visible wrap">
        <div className="text-center">
          ...
          <h4 className="text-center text-black">
            <span className="text-2xl">프론트엔드 개발자, 그리고 예비 프론트엔드 개발자를 위한</span><br/>
            <b className="mt-4 text-2xl">찐으로 도움 되는 선배의 노하우 흡수하기</b>
          </h4>
          <p className="mt-5 text-base text-zinc-600">
            Next.js만 배우고 끝나면 섭섭하죠!<br/>
            오직 프론트엔드 개발자를 위한 취업&이직 준비 방법과,<br/>
