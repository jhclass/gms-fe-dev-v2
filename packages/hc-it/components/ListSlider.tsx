  ...
  const list = [
    {
      ...
      img: 'https://highclass-image.s3.amazonaws.com/academy/hc_it/eximg/thumb04.webp',
    ...
    {
      title: '웹 프론트엔드를 위한 자바스크립트 첫 걸음',
      img: 'https://highclass-image.s3.amazonaws.com/academy/hc_it/eximg/thumb05.webp',
      subs: '프론트엔드 입문자를 위한 개념부터 프로젝트까지 한번에 배우는 자바스크립트',
      link: '/detail/1',
    },
    {
      title: '웹 프론트엔드를 위한 자바스크립트 첫 걸음',
      img: 'https://highclass-image.s3.amazonaws.com/academy/hc_it/eximg/thumb06.webp',
      subs: '프론트엔드 입문자를 위한 개념부터 프로젝트까지 한번에 배우는 자바스크립트',
      link: '/detail/1',
    },
    {
      title: '웹 프론트엔드를 위한 자바스크립트 첫 걸음',
      img: 'https://highclass-image.s3.amazonaws.com/academy/hc_it/eximg/thumb07.webp',
      subs: '프론트엔드 입문자를 위한 개념부터 프로젝트까지 한번에 배우는 자바스크립트',
      link: '/detail/1',
    },
    {
      title: '웹 프론트엔드를 위한 자바스크립트 첫 걸음',
      img: 'https://highclass-image.s3.amazonaws.com/academy/hc_it/eximg/thumb08.webp',
      subs: '프론트엔드 입문자를 위한 개념부터 프로젝트까지 한번에 배우는 자바스크립트',
      link: '/detail/1',
    },
    {
      title: '웹 프론트엔드를 위한 자바스크립트 첫 걸음',
      img: 'https://highclass-image.s3.amazonaws.com/academy/hc_it/eximg/thumb09.webp',
      subs: '프론트엔드 입문자를 위한 개념부터 프로젝트까지 한번에 배우는 자바스크립트',
      link: '/detail/1',
    },
    {
      title: '웹 프론트엔드를 위한 자바스크립트 첫 걸음',
      img: 'https://highclass-image.s3.amazonaws.com/academy/hc_it/eximg/thumb10.webp',
      subs: '프론트엔드 입문자를 위한 개념부터 프로젝트까지 한번에 배우는 자바스크립트',
      link: '/detail/1',
    },
    {
      title: '웹 프론트엔드를 위한 자바스크립트 첫 걸음',
      img: 'https://highclass-image.s3.amazonaws.com/academy/hc_it/eximg/thumb11.webp',
      subs: '프론트엔드 입문자를 위한 개념부터 프로젝트까지 한번에 배우는 자바스크립트',
      link: '/detail/1',
    },
  ]
