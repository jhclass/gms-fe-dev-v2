        ...
        <div className="flex flex-wrap justify-between pb-10 border-b-1">
          ...
          <ul className="text-base lg:w-1/2 md:w-full">
            <li className="relative mt-2 text-base font-normal after:content-['・'] after:absolute after:top-[0.1rem] after:left-0 pl-[1rem]">
              React.js에 대해 알고 있으나, 정작 웹서비스를 만드려면 어떻게 해야
              할지 막막하신 분
            </li>
            <li className="relative mt-2 text-base font-normal after:content-['・'] after:absolute after:top-[0.1rem] after:left-0 pl-[1rem]">
            ...
            <li className="relative mt-2 text-base font-normal after:content-['・'] after:absolute after:top-[0.1rem] after:left-0 pl-[1rem]">
              패스트캠퍼스 ‘한 번에 끝내는 프론트엔드 개발 초격차 패키지’, ‘한
              번에 끝내는 React의 모든 것 초격차 패키지’ 와 같은 강의를 듣고
              조금 더 실무에 가까운 프론트엔드 웹 서비스 개발에 필요성을 느끼는
              분
            </li>
          </ul>
        </div>
        <div className="flex flex-wrap justify-between py-10 border-b-1">
          ...
          <div className="w-full text-base lg:w-1/2">
            <figure className="w-[70%] mx-auto">
              <img
                src="https://highclass-image.s3.amazonaws.com/academy/hc_it/eximg/de_sec7_con01.webp"
                width="100%"
              />
            </figure>
