        ...
        >
          <SwiperSlide style={{ background: '#11181c' }}>
            <Link href="#" onClick={handleTest}>
              <div className="flex justify-end wrap">
                <img
                  src="https://highclass-image.s3.amazonaws.com/academy/hc_it/eximg/main_03.webp"
                  style={{ overflow: 'hidden' }}
                  className="hidden lg:block"
                />
                <img
                  src="https://highclass-image.s3.amazonaws.com/academy/hc_it/eximg/main_03_m.webp"
                  style={{ overflow: 'hidden' }}
          ...
          <SwiperSlide style={{ background: '#332314' }}>
            <Link href="#" onClick={handleTest}>
              <div className="flex justify-end wrap">
                <img
                  src="https://highclass-image.s3.amazonaws.com/academy/hc_it/eximg/main_02.webp"
                  style={{ overflow: 'hidden' }}
                  className="hidden lg:block"
                />
                <img
                  src="https://highclass-image.s3.amazonaws.com/academy/hc_it/eximg/main_02_m.webp"
                  style={{ overflow: 'hidden' }}
                  className="block lg:hidden"
                />
                <div className="absolute top-[48%] left-6 xl:left-0 translate-y-[-50%]">
          ...
          <SwiperSlide style={{ background: '#0c0918' }}>
            <Link href="#" onClick={handleTest}>
              <div className="flex justify-end wrap">
                <img
                  src="https://highclass-image.s3.amazonaws.com/academy/hc_it/eximg/main_04.webp"
                  style={{ overflow: 'hidden' }}
                  className="hidden lg:block"
                />
                <img
                  src="https://highclass-image.s3.amazonaws.com/academy/hc_it/eximg/main_04_m.webp"
                  style={{ overflow: 'hidden' }}
                  className="block lg:hidden"
                />
                <div className="absolute top-[48%] left-6 xl:left-0 translate-y-[-50%]">
          ...
          <SwiperSlide style={{ background: '#b1dcff' }}>
            <Link href="#" onClick={handleTest}>
              <div className="flex justify-end wrap">
                <img
                  src="https://highclass-image.s3.amazonaws.com/academy/hc_it/eximg/main_05.webp"
                  style={{ overflow: 'hidden' }}
                  className="hidden lg:block"
                />
                <img
                  src="https://highclass-image.s3.amazonaws.com/academy/hc_it/eximg/main_05_m.webp"
                  style={{ overflow: 'hidden' }}
                  className="block lg:hidden"
                  width="100%"
                  height="100%"
          ...
          <SwiperSlide style={{ background: '#eee' }}>
            <Link href="#" onClick={handleTest}>
              <div className="flex justify-end wrap">
                <img
                  src="https://highclass-image.s3.amazonaws.com/academy/hc_it/eximg/main_01.webp"
                  style={{ overflow: 'hidden' }}
                  className="hidden lg:block"
                />
                <img
                  src="https://highclass-image.s3.amazonaws.com/academy/hc_it/eximg/main_01_m.webp"
                  style={{ overflow: 'hidden' }}
                  className="block lg:hidden"
                />
                <div className="absolute top-[48%] left-6 xl:left-0 translate-y-[-50%]">
          ...
          <SwiperSlide style={{ background: '#150042' }}>
            <Link href="#" onClick={handleTest}>
              <div className="flex justify-end wrap">
                <img
                  src="https://highclass-image.s3.amazonaws.com/academy/hc_it/eximg/main_06.webp"
                  style={{ overflow: 'hidden' }}
                  className="hidden lg:block"
                />
                <img
                  src="https://highclass-image.s3.amazonaws.com/academy/hc_it/eximg/main_06_m.webp"
                  style={{ overflow: 'hidden' }}
                  className="block lg:hidden"
                />
                <div className="absolute top-[48%] left-6 xl:left-0 translate-y-[-50%]">
