            ...
            <SwiperSlide style={{background:'#0c0918'}}>
              <Link href="#" onClick={handleTest}>
                <div className="flex justify-end wrap">
                  ...
                  <div className="absolute top-[48%] left-6 xl:left-0 translate-y-[-50%]">
                    <p className="inline px-3 py-2 text-center text-white rounded-r-lg rounded-tl-lg text-sm/none md:text-lg bg-primary">신규모집</p>
                    <h2 className="mt-4 text-2xl font-bold text-white md:text-4xl/tight">프론트엔드 개발자를 위한<br/>고성능 대규모 프로젝트</h2>
                    <p className="mt-4 text-white text-md/tight md:text-xl/tight">고퀄리티 10개 프로젝트로<br/>최적화부터 유지보수까지</p>
                  </div>
                </div>
              </Link>
            </SwiperSlide>
            ...
            <SwiperSlide style={{background:'#150042'}}>
              <Link href="#" onClick={handleTest}>
                <div className="flex justify-end wrap">
                  ...
                  <div className="absolute top-[48%] left-6 xl:left-0 translate-y-[-50%]">
                    <p className="inline px-3 py-2 text-center text-white rounded-r-lg rounded-tl-lg text-sm/none md:text-lg bg-primary">신규모집</p>
                    <h2 className="mt-4 text-2xl font-bold text-white md:text-4xl/tight">AI 시대 일잘러를 위한<br/>ChatGPT 활용법</h2>
                    <p className="mt-4 text-white text-md/tight md:text-xl/tight">400가지 활용 사례를 다- 담은 강의<br/>ChatGPT, 너 내 동료가 돼라!</p>
                  </div>
                </div>
              </Link>
            </SwiperSlide>
