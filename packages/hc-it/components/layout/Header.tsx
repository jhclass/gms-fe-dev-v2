          ...
          <div className={`${headerFixed ? 'fixed top-0 left-0 z-40' : 'relative'} flex-col w-full bg-white max-w-full px-0 border-b-1`}>
            <div className="w-full bg-[#27272E] h-[2.5rem]">
              <ul className="flex items-center h-full text-lg wrap">
                <li className="min-w-[4.5rem] h-full cursor-pointer border-x-1 border-slate-400 bg-primary"><Link href="/" className="block w-full h-full text-lg text-center px-2 py-1.5 text-white">IT</Link></li>
                <li className="min-w-[4.5rem] h-full cursor-pointer border-r-1 border-slate-400"><Link href="/" onClick={handleTest} className="block w-full text-lg h-full text-center px-2 py-1.5 text-white">그래픽</Link></li>
              </ul>
            </div>
            <div className="flex wrap items-center justify-between w-full max-w-[1440px] h-[4.5rem] border-b-1 border-primary py-3 lg:border-b-0">
              ...
              <div className="flex items-center justify-end">
                ...
                <Link href="/consult" className="flex items-center justify-center w-10 h-10 mr-2 text-2xl text-white rounded-full lg:hidden bg-primary">
                  <i className="xi-call"/>
                </Link>
                <button
