...
import SearchEmployeeItem from '@/components/items/SearchEmployeeItem'
...
export default function SearchEmployee({ groupSelected, setGroupSelected }) {
                ...
                {managerData?.map((manager, index) => (
                  <TableItem key={index}>
                    <TableRow>
                      ...
                      <SearchEmployeeItem manager={manager} />
                    </TableRow>
                  </TableItem>
                ))}
              </>
