...
export default function QuickMenu() {
  ...
  return (
    <>
      <div className="flex items-center py-5 wrap">
        ...
        <div className="relative w-3/6 mr-10">
          <ul className="flex justify-between">
            <li>
              <Link href={""} className="flex flex-col items-center p-3 text-white border-2 rounded-lg bg-primary border-primary">
                <span className="text-3xl/none"><i className="xi-emoticon-smiley-o" /></span>
                <span className="mt-1">온라인상담</span>
              </Link>
            </li>
            <li>
              <Link href={""} className="flex flex-col items-center p-3 border-2 rounded-lg border-primary text-primary">
                <span className="text-3xl/none"><i className="xi-emoticon-smiley-o" /></span>
